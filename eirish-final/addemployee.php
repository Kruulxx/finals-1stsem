...
if (isset($_POST['save'])) {
    ...
    $link= "INSERT INTO `employee` (`emp_id`, `name`, `address`, `position`, `rate`, `phonenumber`, `sex`, `civil_status`, `emergency_name`, `emergency_contact`) VALUES ('$emp_id', '$name', '$address', '$position', '$rate', '$phonenumber', '$sex', '$civil_status', '$emergency_name', '$emergency_contact');";
    
    
    $query = mysqli_query($con, $link) or die("fuck: $link");
